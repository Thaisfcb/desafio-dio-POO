...
public class Main {
    public static void main(String[] args) {
        ...
        bootcamp.setNome("Bootcamp Java Developer - Potência Tech Powered by Ifood");
        bootcamp.setDescricao("Descrição Bootcamp - Potência Tech Powered by Ifood");
        ...
        System.out.println("Conteudos Concluidos Thais: " + devThais.getConteudosConcluidos());
        System.out.println("XP Thais: " + devThais.calcularTotalXp());
